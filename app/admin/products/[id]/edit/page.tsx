...
export default function EditProductPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!product) {
    return (
      <div className="text-center py-16">
        ...
        <Button onClick={() => router.push("/admin/products")}>상품 목록으로</Button>
      </div>
    )
  }
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      title: "상품이 수정되었습니다",
      description: `${updatedProduct.name}이(가) 성공적으로 수정되었습니다.`,
    })
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="space-y-4">
          ...
          <div>
            ...
            <Input id="image" name="image" value={formData.image} onChange={handleInputChange} className="mt-1.5" />
          </div>
